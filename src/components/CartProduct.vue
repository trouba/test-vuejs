<template>
  <div class="product-group">
    <div class="product-infos">
      <img
        class="product-group__picture "
        v-bind:src="productPicture"
        alt="Card image cap"
      />
    ...
    <button
      ...
      v-on:click="removeFromCart(productGroup)"
    >
...
export default {
  ...
  computed: {
    productPicture: function() {
      return (
        "https://picsum.photos/200/200?image=" + this.productGroup[0].id * 2
      );
    },
    productTitle: function() {
      ...
      productTitle =
        ...
        this.productGroup[0].title.slice(1);
